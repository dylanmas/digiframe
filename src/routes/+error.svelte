<div class="">
    <div class="transition-all duration-500 overflow-clip">
        <div class="bg-neutral-700 w-full h-[100vh]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[50vw] scale-[300%] text-neutral-900">
        ...
        <div class="absolute bottom-0 flex w-full duration-500 transition-all">
            <div class="mx-10 w-full">
                <div class="rounded-3xl my-10 shadow-lg mx-auto bg-neutral-800 gap-5 p-5 flex flex-col text-white items-center">
                    ...
                    <h1>A system error has occurred, and the frame will need to restart.</h1>
                    <div class="w-full flex gap-2 items-center">
                        <h1 class="text-white text-xl text-center mx-auto">
                            If your frame does not automatically restart within 10 seconds, follow these steps:
                        </h1>
                    </div>
                    <div class="w-full flex gap-2 items-center">
                        ...
                        <h1 class="text-white text-xl text-center mr-auto">
                            Locate the sleep button under the frame on the left.
                        </h1>
                    </div>
                    <div class="w-full flex gap-2 items-center">
                        <div class="text-2xl font-bold bg-neutral-600 p-1 w-10 h-10 text-center rounded-full ml-auto">
                        ...
                        <h1 class="text-white text-xl text-center mr-auto">
                            Press down the sleep button until the screen turns black.
                        </h1>
                    </div>
                </div>
            </div>
