    ...
    <div class="bg-neutral-800 w-full p-2 rounded-lg shadow-xl mt-2">
        ...
        <div class="flex flex-col bg-neutral-900 p-2 rounded-lg gap-2 mt-2">
            ...
            <div class="w-full flex items-center bg-neutral-800 rounded-md pl-2 gap-2">
                ...
                <button class="bg-neutral-700 p-1 rounded-md shadow-lg transition-all duration-500 {data.output.imagedata.clocktype == "centerlarger" ? "brightness-110 scale-110" : "brightness-[70%]"}" on:click={() => {changeSettings("image", "clocktype", "centerlarger", "")}}>Center Larger</button>
    ...
    <div class="bg-neutral-800 w-full p-2 rounded-lg shadow-xl space-y-2 mt-2">
        ...
        <div class="flex flex-col bg-neutral-900 p-2 rounded-lg gap-2">
            ...
            <div class="w-full flex items-center gap-2">
                ...
                <button class="bg-neutral-700 p-1 rounded-md shadow-lg w-full" on:click={() => {changeSettings("settings", "power", "restart", "")}}>Restart</button>
                <button class="bg-neutral-700 p-1 rounded-md shadow-lg w-full" on:click={() => {changeSettings("settings", "power", "poweroff", "")}}>Turn off</button>
            </div>
        </div>
    </div>
</div>